...
class Encoder(nn.Module):
    """ The encoder part of the VAE. Currently this is pretty basic using only fully connected layers       Probably should use few convolutional layers and need to check the size of the latent space    """
...
torch.save(model.state_dict(), 'modelweights/VAE_ProtBert_singlemultitrain_singlepredict.pth')
...
fig.update_layout(
    ...
    title_text='Single mutant Test set predictions with ProtBertEmbedding'
)
fig.write_html('plots/embeddings_protbert_singlemutants.html')
